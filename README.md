...
* 🖥️ **专业级多宫格监控矩阵**：告别单画面来回切换，全新引入专业安防级别的 **4宫格 / 6宫格播放矩阵**。支持单路双击全屏、多流智能焦点轮转，搭配按需加载与休眠机制，为你带来沉浸式的大屏监控体验。
* 🏗️ **多平台架构兼容**：原生支持 x86-64 与 ARM64 (树莓派/RK3588等) 架构，完美适配各种专业服务器、家用 NAS 及低功耗边缘设备。
