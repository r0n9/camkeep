...
func startWebServer() {
	...
	protected.GET("/api/camera/:id/record-markers", handleRecordMarkers)
	...
	admin.POST("/api/camera/:id/ptz/autofocus", handlePTZAutoFocus)
	admin.POST("/api/camera/:id/ptz/iris", handlePTZIris)
	admin.POST("/api/camera/:id/ptz/light", handlePTZLight)
